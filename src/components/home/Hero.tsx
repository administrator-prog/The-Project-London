  ...
  return (
    <section ref={ref} className="relative h-[100svh] min-h-[640px] w-full overflow-hidden bg-ink">
      ...
      >
        ...
        >
          <Link to={hero.cta.href} className="group inline-flex items-center gap-4 label-lg text-bone">
            <span className="border-b border-bone/50 pb-3.5 transition-colors duration-500 group-hover:border-bone">
              {hero.cta.label}
            </span>
            <ArrowRight
              size={26}
              strokeWidth={1.25}
              className="mb-3.5 transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:translate-x-1"
            />
          </Link>
        </motion.div>
      </motion.div>
